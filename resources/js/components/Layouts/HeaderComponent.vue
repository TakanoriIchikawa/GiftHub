...
<header class="c-header c-header-light c-header-fixed c-header-with-subheader">
    <button class="c-header-toggler c-class-toggler d-lg-none mfe-auto" type="button" data-target="#sidebar" data-class="c-sidebar-show">
        <svg class="c-icon c-icon-lg">
            <use href="/assets/coreui.icon.svg#cil-menu"></use>
        </svg>
    </button>
    ...
    <ul class="c-header-nav ml-auto mr-4">
        <li class="c-header-nav-item d-md-down-none mx-2">
            <a class="c-header-nav-link" href="#">
                <svg class="c-icon">
                    <use href="/assets/coreui.icon.svg#cil-bell"></use>
                </svg>
            </a>
        </li>
        <li class="c-header-nav-item d-md-down-none mx-2">
            <a class="c-header-nav-link" href="#">
                <svg class="c-icon">
                    <use href="/assets/coreui.icon.svg#cil-list-rich"></use>
                </svg>
            </a>
        </li>
        <li class="c-header-nav-item d-md-down-none mx-2">
            <a class="c-header-nav-link" href="#">
                <svg class="c-icon">
                    <use href="/assets/coreui.icon.svg#cil-envelope-open"></use>
                </svg>
            </a>
        </li>
        <li class="c-header-nav-item dropdown">
            <a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                <div class="c-avatar">
                    <img class="c-avatar-img" src="/assets/img/avatars/3.jpg" alt="">
                </div>
            </a>
            ...
            <div class="dropdown-menu dropdown-menu-right pt-0">
                <div class="dropdown-header bg-light py-2"><strong>Account</strong></div>
                    <a class="dropdown-item" href="#">
                        <svg class="c-icon mr-2">
                            <use xlink:href="assets/coreui.icon.svg#cil-bell"></use>
                    ...
                    <a class="dropdown-item" href="#">
                        <svg class="c-icon mr-2">
                            <use xlink:href="assets/coreui.icon.svg#cil-task"></use>
                        </svg> Tasks<span class="badge badge-danger ml-auto">42</span>
                    </a>
                    <a class="dropdown-item" href="#">
                        <svg class="c-icon mr-2">
                            <use xlink:href="assets/coreui.icon.svg#cil-comment-square"></use>
                ...
                <div class="dropdown-header bg-light py-2"><strong>Settings</strong></div>
                    ...
                    <a class="dropdown-item" href="#">
                        <svg class="c-icon mr-2">
                            <use xlink:href="assets/coreui.icon.svg#cil-settings"></use>
                        </svg> Settings
                    </a>
                    <a class="dropdown-item" href="#">
                        <svg class="c-icon mr-2">
                    ...
                    <a class="dropdown-item" href="#">
                        <svg class="c-icon mr-2">
                            <use xlink:href="assets/coreui.icon.svg#cil-file"></use>
